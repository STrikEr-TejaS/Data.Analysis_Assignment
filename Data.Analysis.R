...
piee<- round(100*myy$Client.Code/sum(myy$Client.Code), 1)
...
tableplot(m2, select = c("age", "job", "martial", "housing", "default", "loan"), sortCol = response, 
          from = 0, to = 6)

tableplot(m2, select = c(age, job, housing, default, loan, response), sortCol = age, 
          from = 0, to = 6)
